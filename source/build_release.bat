...
lld-link /nologo /dll /nodefaultlib /subsystem:windows /entry:DllMain /out:helicopter_distribution_office.dll hdo.obj tinycrt.obj user32_import.obj /include:__IMPORT_DESCRIPTOR_USER32 || exit /b 1
python finalize_pe.py helicopter_distribution_office.dll || exit /b 1

echo Built helicopter_distribution_office.dll v1.1.0
endlocal
